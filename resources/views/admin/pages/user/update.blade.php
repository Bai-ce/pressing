            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="AGENT_PRESSING" {{ old('role', $user->role) === 'AGENT_PRESSING' ? 'selected' : '' }}>Agent Pressing</option>
                ...
                <!-- Password -->
                <div>
                    <x-input-label for="password" :value="__('Mot de passe (optionnel)')" />
                    <x-text-input
                        id="password"
                        class="mt-1 block w-full"
                        type="password"
