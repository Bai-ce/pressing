...
<div x-data="serviceManager()">
    ...
    <div class="mb-4 flex justify-end">
        <button @click="openModal('addServiceModal')" class="inline-flex items-center gap-2 px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-blue-600 shadow-sm hover:bg-blue-700">
            Ajouter un service
        </button>
    </div>
                ...
                <tr>
                    ...
                    <td class="py-3">
                        <div class="flex items-center gap-2">
                            ...
                            <a href="{{ route('services.edit', $service) }}" class="p-2 rounded-lg border border-gray-300 bg-white text-blue-600 hover:bg-blue-50 transition" title="Modifier">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
