                        ...
                        @if($service->image)
                            <div class="w-24 h-24 rounded-lg overflow-hidden border border-gray-300">
                                @if(str_starts_with($service->image, 'http'))
                                    <img src="{{ $service->image }}" alt="{{ $service->nom }}" class="w-full h-full object-cover">
                                @else
                                    <img src="{{ Storage::url($service->image) }}" alt="{{ $service->nom }}" class="w-full h-full object-cover">
                                @endif
                            </div>
                        @endif
