...
<div>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white px-6 py-6">
            <h3 class="text-lg font-semibold text-gray-800 mb-6">Créer un nouveau forfait</h3>

            <form action="{{ route('admin.forfaits.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="3"
                        ...
                        placeholder="Description courte du forfait">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="montant" id="montant" value="{{ old('montant') }}" required min="0"
                    ...
                    <div>
                        ...
                        <input type="number" name="duree_jours" id="duree_jours" value="{{ old('duree_jours', 30) }}" required min="1"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('duree_jours') border-red-500 @enderror"
                            placeholder="30">
                        @error('duree_jours')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="credits" id="credits" value="{{ old('credits') }}" required min="1"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('credits') border-red-500 @enderror"
                ...
                <div class="mb-6 flex flex-wrap gap-6">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="est_populaire" value="1" {{ old('est_populaire') ? 'checked' : '' }}
