<!-- Login.blade.php -->
<x-guest-layout>
<div x-data="{ page: 'login', 'loaded': true }">
        ...
        <div class="relative flex h-screen w-full flex-col justify-center lg:flex-row ">
            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                <div class="mx-auto w-full max-w-md pt-10">
                    <a href="{{ route('home') }}" class="inline-flex items-center text-sm text-gray-500 transition-colors hover:text-gray-700">
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        ...
                        <!-- Login Form -->
                        <form method="POST" action="{{ route('login') }}" class="mt-5 sm:mt-8">
                            @csrf
